...
import app.reatailx.sellitapp.Activites.CompleteleadItemdescriptionActivity;
...
public class CompleteLead_Adapter extends RecyclerView.Adapter<CompleteLead_Adapter.MyViewHolder> {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            super(view);
            productname_ip = (TextView) view.findViewById(R.id.productname_cl);
            vendorname_ip = (TextView) view.findViewById(R.id.vendorname_cl);
            agent_name_ip = (TextView) view.findViewById(R.id.agent_name_cl);
            datetime_ip = (TextView) view.findViewById(R.id.datetime_cl);
            location_ip = (TextView) view.findViewById(R.id.location_cl);
            phone_price_des = (TextView) view.findViewById(R.id.phone_price_cl);
            commision_price_ip = (TextView) view.findViewById(R.id.commision_price_cl);
            image_ip = (ImageView) view.findViewById(R.id.image_cl);
            layout_covercview_mainclick_new = (LinearLayout) view.findViewById(R.id.linaercoverclickcl);
        }
    }

    public CompleteLead_Adapter(List<Inprogressmodel> electronicsItems, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.completelead_adapter, parent, false);
