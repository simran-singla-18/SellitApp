...
public class InprogressActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public Inprogress_Adapter listAdapter;
    public RecyclerView recyclerView;
    public InprogressActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inprogress_activity);
        activity = this;
        ...
        swipeRefreshLayout = findViewById(R.id.swiperefreshmainip);
        recyclerView = findViewById(R.id.recycle_inprogresslist);
        relativeLayout_back = findViewById(R.id.back_ip);
        relativeLayout_back.setOnClickListener(this);

        linearLayoutManager = new LinearLayoutManager(activity);
        listAdapter = new Inprogress_Adapter(modleonefgr_array1, activity);
    ...
    private void progressDialog() {
        kProgressHUD = new KProgressHUD(InprogressActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://sellit.co.in/logisticapi/v1/ajantleads.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        System.out.println("msg_fonemaininprogressmainactivity_agent:::::" + response);
                        if (response == null) {
    ...
    private void getJSON() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://sellit.co.in/logisticapi/v1/allleads.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        System.out.println("msg_fonemaininprogressmainactivity_vendor:::::" + response);
                        if (response == null) {
                            swipeRefreshLayout.setRefreshing(false); // Disables the refresh icon
                            dismissDialog();
                        } else {
